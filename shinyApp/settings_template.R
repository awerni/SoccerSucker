...
helpGer <- paste("Für den richtigen Sieger (1, 2 oder X) gibt es 3 Punkte, die richtige Tordifferenz", 
                 ...
                 "Ab der KO –Runde gelten die gleichen Regeln, nur gibt es doppelte Punkte.",
                 "Da das Spiel ab der KO-Runde nach 90 Minuten oft noch nicht entschieden ist,",
                 ...
                 "gibt es auch für alle, die sich für den richtigen Sieger nach der regulären Spielzeit entschieden haben.")
...
helpEng <- paste("For the correct winner (1, 2, or X) there are 3 points to earn. The right",
                 ...
                 "The points are rewarded after the regular time (90 min. + over time, excluding extra time !!).",
                 "From the KO-phase on, the same rules apply, but with double points.",
                 "In the KO-phase the decision is sometimes not made after the regular time.",
